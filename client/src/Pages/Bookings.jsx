...
const Bookings = () => {
  ...
  const handleCreateBooking = async (e) => {
    ...
    try {
      // Basic validation
      if (!newBooking.customer || !newBooking.product || !newBooking.startDate || !newBooking.endDate) {
                ...
                {getBookingsForDate(selectedDate).length > 0 ? (
                  <div className="space-y-2">
                    <p className="text-sm text-blue-700">
                      {getBookingsForDate(selectedDate).length} booking(s) on this date:
                    </p>
                    {getBookingsForDate(selectedDate).map((booking, index) => (
                      <div key={index} className="text-sm bg-white p-2 rounded border border-blue-200">
                        <span className="font-medium">{booking.customer}</span> - {booking.product}
                      </div>
                    ))}
                  </div>
                ) : (
                  <p className="text-sm text-blue-700">No bookings on this date</p>
                )}
              </div>
            )}
          ...
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-2xl max-h-[95vh] overflow-hidden relative">
            ...
            <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 px-8 py-6 relative overflow-hidden">
              ...
              <div className="relative flex items-center justify-between">
                <div>
                  <h2 className="text-2xl font-bold text-white mb-1">Create New Booking</h2>
                  <p className="text-blue-100 text-sm">Schedule a new rental reservation</p>
                </div>
                <button
            ...
            <div className="p-8 max-h-[calc(95vh-120px)] overflow-y-auto">
              <form className="space-y-6">
                ...
                <div className="bg-gradient-to-br from-purple-50 to-white border border-purple-200 rounded-2xl p-6">
                  ...
                  <div className="mt-4 p-3 bg-purple-50 border border-purple-200 rounded-xl">
                    <p className="text-sm text-purple-700 flex items-center">
                      ...
                      💡 Tip: Changing dates will automatically recalculate the rental duration and pricing
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-2xl p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-white p-4 rounded-xl border border-gray-200">
                      <label className="block text-sm font-semibold text-gray-500 mb-1">Customer</label>
                    ...
                    <div className="bg-white p-4 rounded-xl border border-gray-200">
                      ...
                      <p className="text-sm text-gray-900">{selectedBooking.product}</p>
                    </div>
                    <div className="bg-white p-4 rounded-xl border border-gray-200">
                      <label className="block text-sm font-semibold text-gray-500 mb-1">Duration</label>
