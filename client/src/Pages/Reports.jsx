  ...
  const fetchReportsData = async () => {
    try {
      ...
      if (ordersResponse.success) {
        ...
        // Generate real revenue trend data from actual orders
        ...
        setRevenueData(generateRevenueData(ordersList))
      }
                  ...
                  return (
                    <div key={index} className="flex-1 flex flex-col items-center group relative">
                      ...
                      <div className="text-center space-y-1">
                        <span className="text-sm font-semibold text-gray-700 block">{data.month}</span>
